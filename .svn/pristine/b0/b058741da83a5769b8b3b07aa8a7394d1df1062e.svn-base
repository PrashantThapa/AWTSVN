<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="TrialBalance.aspx.cs" Inherits="HRFA.Modules.REPORTING.ACCOUNT.TrialBalance" %>
...
<div class="wrapper">
<div class="col-md-10">
<h3 class="margin-top-15 margin-left-25">Trial Balance</h3>
...
<div class="col-md-3">
    ...
    <script src="../../../Scripts/REPORTING/ACCOUNT/TrialBalance.js" type="text/javascript"></script>
</asp:Content>
