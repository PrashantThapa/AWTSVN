...
{
	public class DLLPayrollEmployeeSalaryRep
	{
		public ATTPayrollEmployeeSalaryRep ViewReport(int? OfficeCD, int? CostCenterID, int? SalYear, int? SalMonth)
		{
			...
			try
			{
				...
				ATTPayrollEmployeeSalaryRep objEmpSalary = new ATTPayrollEmployeeSalaryRep();
