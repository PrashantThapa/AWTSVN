...
{
	public class DLlEmpSalarySheet
	{
		public ATTPayrollSalarySheet ViewReport(int? OfficeCD, int? CostCenterID, int? SalYear, int? SalMonth)
		{
			...
			try
			{
				...
				ATTPayrollSalarySheet objEmpSalary = new ATTPayrollSalarySheet();
