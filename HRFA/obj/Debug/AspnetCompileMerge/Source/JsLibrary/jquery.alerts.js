		...
		_show: function (title, msg, value, type, callback) {
			...
			switch (type) {
				...
				case 'failure':
					...
					break;
				case 'confirm':
					$("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.okButton + '" id="popup_ok" style="cursor:pointer; background:#438cca; color:#fff;" /> <input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" style="cursor:pointer; width:80px;background: #438cca; color: #fff; border-radius: 4px; border: none; padding: 5px!important; font-size: 14px;" /></div>');
					$("#popup_ok").click(function () {
						$.alerts._hide();
