<%@ Page Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ShiftScheduleInfoReport.aspx.cs" Inherits="HRFA.Modules.REPORTING.PIS.ShiftScheduleInfoReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Shift Schedule Info Report</h3>
					</div>
					<!-- /.box-header -->
					<!-- form start -->
	...
	optionsCaption: "--- Select One ---"'>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<button type="button" class="btn btn-primary" data-bind="click: ViewReportShiftScheduleList" id="EmpDet">
											View Shift Schedule Report</button>
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<div class="box-body">
								...
								<div class="row" data-bind="if: ShiftScheduleEmps().length > 0">
									<div class="col-md-12">
										<label>Office Name : <span data-bind="text: ShiftScheduleEmps()[0].OFFICE_NAME_NEPALI"></span></label>
										<label class="pull-right">Department : <span data-bind="text: ShiftScheduleEmps()[0].DEPT_DESC"></span></label>
									</div>
									<div class="col-md-12">
										<div class="table-responsive">
											<table class="table-bordered table-condensed table-striped sort col-lg-12">
												...
												<tbody data-bind="foreach: ShiftScheduleEmps">
													<tr>
														<td data-bind="text: ($index() + 1)"></td>
														<td data-bind="text: SHIFT_NAME"></td>
														<td data-bind="text: SCHEDULE"></td>
														<td data-bind="text: DEPT_DESC"></td>
													</tr>
												</tbody>
											</table>
										</div>
...
<script type="text/javascript">
	...
	<script src="../../../Scripts/REPORTING/PIS/ShiftScheduleInfoReport.js" type="text/javascript"></script>
