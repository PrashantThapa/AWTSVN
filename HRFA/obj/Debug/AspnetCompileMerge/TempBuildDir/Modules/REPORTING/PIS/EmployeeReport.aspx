	<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="EmployeeReport.aspx.cs" Inherits="HRFA.Modules.REPORTING.PIS.EmployeeReport" %>
				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						<div class="box-header with-border">
							<h3 class="box-title">Employee Personal Information Report</h3>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" id="txtSymbol"
												...
												class="form-control" data-bind="value: SymbolNo" />
										</div>
									</div>
									...
									<div class="col-md-6 wordlong">
										<div class="form-group">
											...
											<button class="btn btn-primary" data-bind="click: GetEmployeeDetails">View Report</button>
...
<%--														<td data-bind=" POSTING_TYPE_ID = 'A' ? text:FROM_DATE"></td>--%>
	...
	<script src="../../../Scripts/REPORTING/PIS/EmployeeReport.js" type="text/javascript"></script>
	</asp:Content>
