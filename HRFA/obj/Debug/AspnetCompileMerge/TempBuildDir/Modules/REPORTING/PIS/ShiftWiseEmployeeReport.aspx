<%@ Page Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ShiftWiseEmployeeReport.aspx.cs" Inherits="HRFA.Modules.REPORTING.PIS.ShiftWiseEmployeeReport" %>

<asp:Content ID="Contner2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Shift Wise Employee Report</h3>
					</div>
					<!-- /.box-header -->
					<!-- form start -->
	...
	optionsCaption: "--- Select One ---", event{ change: GetDepartment }'>
										</select>
									</div>
								</div>
								<div class="col-md-6">
	...
	optionsValue: "DeptID", value: SelectedLstDepart,
	optionsCaption: "--- Select One ---"'>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<button type="button" class="btn btn-primary" data-bind="click: ViewReportShiftWiseEmployee" id="EmpDet">
											View Shift Wise Employee Report</button>
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<div class="box-body">
								...
								<div class="row" data-bind="if: ShiftWiseEmps().length > 0">
									<div class="col-md-12">
										<label>Office Name : <span data-bind="text: ShiftWiseEmps()[0].OFFICE_NAME_NEPALI"></span></label>
										<label class="pull-right">Department : <span data-bind="text: ShiftWiseEmps()[0].DEPT_DESC"></span></label>
									</div>
									<div class="col-md-12">
										<div class="table-responsive">
											<table class="table-bordered table-condensed table-striped sort col-lg-12">
												...
												<tbody data-bind="foreach: ShiftWiseEmps">
													<tr>
														<td data-bind="text: ($index() + 1)"></td>
														<td data-bind="text: SHIFT_NAME"></td>
														<td data-bind="text: SHIFT_TIMING"></td>
	...
	<script src="../../../Scripts/REPORTING/PIS/ShiftWiseEmployeeReport.js" type="text/javascript"></script>
</asp:Content>
