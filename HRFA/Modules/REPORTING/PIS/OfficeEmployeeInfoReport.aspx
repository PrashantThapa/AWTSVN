...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	optionsCaption: "------ Select one -------"'>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<button type="button" class="btn btn-primary" data-bind="click: ViewEmployeeReport" id="hidehist">
											view employee report</button>
									<%--	<button type="button" class="btn btn-primary" data-bind="click:ViewReportDepartmentList" id="hidefunction">
	...
	<section class="content" style="display: none" id="showfunction">
			<div class="row print" id="ignorePDF">
				<div class="col-xs-12">
					<div class="form-group">
						<button type="submit" class="btn btn-info" id="btnExport">Excel</button>
						<button type="submit" class="btn btn-info" onclick="javascript:demoFromHTML();">PDF</button>
						<button type="submit" class="btn btn-default pull-right" onclick="printDivFunc()">Print</button>
					</div>
				</div>
			</div>
			<div class="row" id="try">
				<div id="testFunc" class="testing">
					<!-- left column -->
					<div class="col-md-12">
						<!-- general form elements -->
						<div class="box box-primary">
							<div class="box-header with-border">
								<h3 class="box-title">Employee/Department's Description</h3>
								<span class="pull-right">Date: <span id="currNepsDate" /></span>
							</div>
							<div class="box-body">
								<div class="row" data-bind="if: OfficeInfos">
	...
	<script type="text/javascript">
		...
		function printDivFunc() {
			var printContents = document.getElementById('testFunc').innerHTML;
			var originalContents = document.body.innerHTML;
			document.body.innerHTML = printContents;
			window.print();
			document.body.innerHTML = originalContents;
