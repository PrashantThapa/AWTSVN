								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select id="lstLeaveType" multiple class="form-control" style="min-height: 270px; width: 100%;"
											data-bind="options: LeaveTypes, optionsText: 'LeaveTypeName', optionsValue: 'LeaveTypeID',
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input class="form-control" id="" placeholder="Name" data-bind="value: LeaveTypeName" />
	...
	optionsCaption: "------Select one -------"'>
									...
									<div class="row wordlong">
										<div class="col-md-6">
											...
											<div class="form-group">
											<input type="checkbox" id="txtIsReservable"   data-bind="checked: IsReservable" class="minimal" />&nbsp;Leave can be Accumulated
											</div>
											</div>
										<div class="col-md-6">
