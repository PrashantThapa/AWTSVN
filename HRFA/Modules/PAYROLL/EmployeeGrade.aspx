...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	optionsValue: $data, value: SelectedGradeID, event: { change: GradeChange },
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <%-- <input type="text" class='required form-control' data-bind="GradeNumber"
                                            />--%>
                                        <select id="" class="form-control select2"
                                            data-bind='options: GradeChanges, optionsText: "GradeLevelName",
	optionsValue: $data, value: SelectedGradeLevel, event: { change: GradeLevelChange },
    optionsCaption: "------ Select One -------"'>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <table data-bind="visible: true" border="0" class="table table-bordered table-striped">
                                        ...
                                        <tbody data-bind="foreach: ExtraAllowances">
                                            <tr>
                                                <td>
                                                    <span data-bind="text:($index() + 1)"></span><span data-bind="text: EAID" style="width: 100px; visibility: hidden;" /><span data-bind="text: Action" />
                                                </td>
                                                <td>
